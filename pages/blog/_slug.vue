<template lang="pug">
  div(class='flex justify-center item-align-center')
    article(class='flex flex-col pt-8 pb-8 w-3/4 border-b-2 border-light-accent dark:border-dark-accent')
      h1(class='text-2xl pl-4 py-4 inline rounded-tl-lg rounded-br-lg bg-gradient-to-r from-light-danger via-light-accent to-light dark:from-dark dark:via-dark dark:to-dark font-bold leading-tight text-light-primary dark:text-dark-secondary')
        | {{ blo.title }}
